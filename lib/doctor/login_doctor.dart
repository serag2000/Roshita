...
import 'package:project/doctor/create_account_doctor.dart';
import 'package:project/doctor/forget_password_doctor.dart';
                      ...
                      onTap: () {
                        {
                          if (formKey.currentState!.validate()) {
                            ...
                            Navigator.pushReplacement(context, MaterialPageRoute(builder:(context) => const ProfileDoctorScreen(),));
                          }
                        }
                      },
                      child: Container(
